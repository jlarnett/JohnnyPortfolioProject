        ...
        <div className="p-0">
            <div className="min-height-40 max-height-40">
                ...
                <div className="p-2 text-left font-sans break-word break-after max-height-20 ...">
                    <div className="p-1 text-left text-md font-serif font-bold break-word ... " data-textid='HeaderName'>Johnny Arnett <span className="text-gray-400 font-light text-sm">(pronounced: jon-ee Ar-nett)</span></div>
                    <div className="p-1 text-left text-md font-serif break-word ..." data-textid='HeaderJobTitle'>FS Software Engineer, USI, 2015 - current (2025)</div>
                    <div className="p-1 text-left text-md font-serif break-word ..." data-textid='HeaderExpertise'><span className='font-bold'>Expertise: </span>in Quality Engineering & Scalable .NET Architecture</div>
                    <div className="p-1 text-left text-md font-serif break-word ..." data-textid='HeaderResearch'><span className='font-bold'>Research: </span>Automating Software Testing Using AI-Driven Playwright Frameworks and</div>
                    <div className="p-1 text-left text-md font-serif break-word ..." data-textid='HeaderNephalemBuilds'>Test Framework Execution Speed Optimization</div>
            ...
            <div className='float-left'>
                <div className='text-left' data-textid='PortfolioHomeTextDescription'>
