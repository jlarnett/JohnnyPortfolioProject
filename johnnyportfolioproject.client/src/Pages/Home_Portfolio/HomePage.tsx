        ...
        <div className="text-black-900 container mx-auto px-4">
            ...
            <div className="min-height-40 max-height-40">
                ...
                <div className="p-2 text-left font-sans break-word break-after max-height-20 ...">
                    <div className="p-1 text-left text-md font-serif text-lg font-bold break-word ... " data-testid='HeaderName'>Johnny Arnett <span className="text-gray-700 dark:text-cyan-500 font-light text-base">(pronounced: jon-ee Ar-nett)</span></div>
            ...
            <div className='float-left text-lg p-2'>
                ...
                <div className='text-left' data-testid='PortfolioConnectLinks' >Connect with me @JohnnyArnett on <a href='https://www.linkedin.com/in/johnny-arnett-350959135/' className='font-medium underline dark:text-cyan-200 dark:hover:text-cyan-400 dark:visited:text-cyan-600 text-blue-600 hover:text-blue-800 visited:text-purple-600'>LinkedIn</a>, <a href='https://www.instagram.com/jaynett96/#' className='font-medium underline dark:text-cyan-300 dark:hover:text-cyan-400 dark:visited:text-cyan-600 text-blue-600 hover:text-blue-800 visited:text-purple-600'>Instagram</a>, <a href='https://nhaindustries.azurewebsites.net/' className='font-medium underline dark:text-cyan-200 dark:hover:text-cyan-400 dark:visited:text-cyan-600 text-blue-600 hover:text-blue-800 visited:text-purple-600'>NHASocial</a>, <a href='https://www.facebook.com/johnny.arnett.9/' className='font-medium underline dark:text-cyan-200 dark:hover:text-cyan-400 dark:visited:text-cyan-600 text-blue-600 hover:text-blue-800 visited:text-purple-600'>Facebook</a>, and <a href='https://www.youtube.com/@NHA_Coyote' className='font-medium underline dark:text-cyan-200 dark:hover:text-cyan-400 dark:visited:text-cyan-600 text-blue-600 hover:text-blue-800 visited:text-purple-600'>Youtube</a>.</div>
                <br />
                ...
                <ul className='text-left' data-testid='PortfolioRecreationalList'>
                    <li>- Running</li>
                    <li>- <a href='https://www.youtube.com/shorts/KOcVdj3YZc0' className='font-medium underline dark:text-cyan-200 dark:hover:text-cyan-400 dark:visited:text-cyan-600 text-blue-600 hover:text-blue-800 visited:text-purple-600'>Streaming Rocket League</a></li>
                </ul>
